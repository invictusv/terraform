...
resource "random_password" "password" {
  ...
  override_special = "_%@"
    ...
    Namespace = var.namespace,
    Stage     = var.stage,
    Name      = "${var.namespace}-random-pass"
  }
}
